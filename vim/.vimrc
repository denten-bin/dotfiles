...
set columns=115                 " How many columns to display. Works with textwidth to produce right margin.
...
set textwidth=91                " Auto text wrapping width, 0 to disable. 78 seems to be the default
